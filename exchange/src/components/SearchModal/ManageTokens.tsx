...
import { Token } from '@koffeeswap/sdk'
import CurrencyLogo from 'components/CurrencyLogo'
import { getKccScanLink, isAddress } from 'utils'
...
export default function ManageTokens({
      ...
      userAddedTokens.map(token => (
        <RowBetween key={token.address} width="100%">
          <RowFixed>
            ...
            <ExternalLink href={getKccScanLink(chainId, token.address, 'address')}>
          ...
          <RowFixed>
            ...
            <ExternalLinkIcon href={getKccScanLink(chainId, token.address, 'address')} />
          </RowFixed>
        </RowBetween>
      ))
    )
  ...
  return (
    <Wrapper>
      <Column style={{ width: '100%', flex: '1 1', height: '100%', overflow: 'hidden scroll' }}>
